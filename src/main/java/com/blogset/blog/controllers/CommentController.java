...
public class CommentController {
	...
	public ResponseEntity<CommentDto> createComment(@RequestBody CommentDto commnetDto, @PathVariable Integer postId){
		
		CommentDto createComment = this.commentService.createComment(commnetDto, postId);
